                        ...
                        <table class="inner-body" align="center" width="570" cellpadding="0" cellspacing="0" role="presentation" style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; box-sizing: border-box; background-color: #ffffff; margin: 0 auto; padding: 0; width: 570px; -premailer-cellpadding: 0; -premailer-cellspacing: 0; -premailer-width: 570px;">
                            ...
                            <tr>
                                <td class="content-cell" style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; box-sizing: border-box; padding: 35px;">
                                    <h3 style="margin-bottom: 1px; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; box-sizing: border-box; color: #3d4852; font-size: 19px; font-weight: bold; margin-top: 0; text-align: left;">Detalhamento da mensagem</h3>
                                    <small style="color: #6c6c6c;">Dados sobre a mensagem recebida em {{$messageReceived->created_at->format('d/m/Y')}} às {{$messageReceived->created_at->format('G:i')}}.</small>
                                    <table class="action" align="left" width="100%" cellpadding="0" cellspacing="0" role="presentation" style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; box-sizing: border-box; margin: 30px auto; padding: 0; text-align: center; width: 100%; -premailer-cellpadding: 0; -premailer-cellspacing: 0; -premailer-width: 100%;">
                                        <tr>
                                            <td width="70px" style="text-align: left;; padding: 5px 0;" class="text-muted">Nome:</td>
                                            <td style="text-align: left">{{$messageReceived->name}}</td>
                                        </tr>
                                        <tr>
                                            <td width="70px" style="text-align: left;; padding: 5px 0;" class="text-muted">Email:</td>
                                            <td style="text-align: left">{{$messageReceived->email}}</td>
                                        </tr>
                                        <tr>
                                            <td width="70px" style="text-align: left; padding: 5px 0;" class="text-muted">Telefone:</td>
                                            <td style="text-align: left">{{$messageReceived->phone}}</td>
                                        </tr>
                                        <tr>
                                            <td width="70px" style="text-align: left;; padding: 5px 0;" class="text-muted">Assunto:</td>
                                            <td style="text-align: left">{{$messageReceived->subject->description}}</td>
                                        </tr>
                                    </table>
